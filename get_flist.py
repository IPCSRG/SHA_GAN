...
parser.add_argument('--folder_path', default=r'D:\pen-model\datazip\Original-image', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='./data/images/train_shuffled.flist', type=str,
                    help='The train filename.')
parser.add_argument('--validation_filename', default='./data/images/validation_static_view.flist', type=str,
